 ...
 */
final class Version20230405172708 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, host_id INT NOT NULL, refugee_id INT NOT NULL, service_id INT NOT NULL, date_reservation DATE DEFAULT NULL, code_reservation VARCHAR(255) DEFAULT NULL, resume LONGTEXT DEFAULT NULL, begin_date DATE NOT NULL, end_date DATE NOT NULL, INDEX IDX_42C849551FB8D185 (host_id), INDEX IDX_42C849557ECD7344 (refugee_id), INDEX IDX_42C84955ED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
